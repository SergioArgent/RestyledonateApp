...
import com.example.restyledonate.databinding.FragmentMensajesBinding;

public class MensajesFragment extends Fragment {

    private MensajesViewModel catalogoViewModel;
private FragmentMensajesBinding binding;
    ...
    View root = binding.getRoot();
        ...
        catalogoViewModel.getText().observe(getViewLifecycleOwner(), new Observer<String>() {
            @Override
