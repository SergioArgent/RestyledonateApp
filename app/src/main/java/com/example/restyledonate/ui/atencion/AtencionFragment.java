...
import com.example.restyledonate.databinding.FragmentAtencionBinding;

public class AtencionFragment extends Fragment {

    private AtencionViewModel atencionViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        atencionViewModel.getText().observe(getViewLifecycleOwner(), new Observer<String>() {
            @Override
